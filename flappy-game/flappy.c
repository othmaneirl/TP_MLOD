                ...
                while(SDL_PollEvent(&event)) switch(event.type)
                {
                        ...
                        case SDL_KEYDOWN:
                                ...
                                if (event.key.keysym.sym == SDLK_p){
                                        couleur+=1;
                                        char filename[50]; 
                                        sprintf(filename, "res/pillar%d.bmp", couleur % 3); 
                                ...
                                if (event.key.keysym.sym == SDLK_b){
                                         couleurb+=1;
                                         char filename2[50]; 
                                         sprintf(filename2, "res/background%d.bmp", couleurb % 2); 
                                         surf = SDL_LoadBMP(filename2);
...
void setup()
{
        ...
        sprintf(filename, "res/pillar%d.bmp", couleur % 3); 
        surf = SDL_LoadBMP(filename);
        // surf = SDL_LoadBMP("res/pillar%d.bmp",couleur%3);
        SDL_SetColorKey(surf, 1, 0xffff00);
        pillar = SDL_CreateTextureFromSurface(renderer, surf);
        surf = SDL_LoadBMP("res/background1.bmp");
        background = SDL_CreateTextureFromSurface(renderer, surf);
